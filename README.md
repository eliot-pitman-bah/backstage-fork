...
This is a customized fork of Backstage for BIP-BIH. For information on publishing custom plugins to our internal Nexus registry, see [PUBLISHING_CUSTOM_PLUGINS.md](PUBLISHING_CUSTOM_PLUGINS.md).
